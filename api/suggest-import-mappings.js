      ...
      messages: [
        {
          ...
          content: [
            ...
            "When mapping Learning Outcomes, return the exact full Learning Outcome label with LO code from allowedCards, not a shortened LO code.",
            "Read and check the learning outcomes carefully, look out for key words and map a Learning Outcome only when that unit explicitly contains an LO code or Learning Outcome number, or close official LO wording.",
            ...
            "For core learning experiences, only map Drawing cards when the spreadsheet explicitly contains Observe, Think, or Imagine in a drawing/core-experience row of the respective unit column.",
            "For core learning experiences, only map Portfolio cards when the spreadsheet explicitly contains Document, Curate, Reflect, or (Re)present/Re-present/Represent in a portfolio/core-experience row of the respective unit column.",
            ...
            "If lesson outline evidence is weak, return an empty lessonOutlines array.",
